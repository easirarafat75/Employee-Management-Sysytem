...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->LOGIN->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->LOGIN->Location = System::Drawing::Point(201, 38);
			this->LOGIN->Name = L"LOGIN";
			this->LOGIN->Size = System::Drawing::Size(200, 25);
			this->LOGIN->TabIndex = 1;
			this->LOGIN->Text = L"Add New Employee";
			// 
			// label1
			// 
			...
			this->label3->Location = System::Drawing::Point(128, 159);
			...
			this->label4->Location = System::Drawing::Point(128, 189);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(224, 91);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(224, 125);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(224, 156);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(224, 189);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(224, 267);
